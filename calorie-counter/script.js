...
function isInvalidInput(str) {
  const regex = /\de\d/i;
  return str.match(regex); // falsy if no match found as NULL returned, truthy otherwise
}

function addEntry() {
  const targetContainer = calorieCounter.querySelector(`#${entryDropdown.value} .input-container`);
  ...
  const HTMLString = `
    ...
    <input type="number" id="entry-${entryNumber}-calories" min="0" placeholder="Calories" />
  `;
